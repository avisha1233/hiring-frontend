...
// Backward-compatible aliases used by some admin pages.
export const markNotificationAsRead = (id) => markAsRead(id);
export const sendNotification = (data) => createNotification(data);
